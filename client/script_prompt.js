...
//const text = "Crear una lista de 15 nombres de categorías que agrupan palabras claves importantes para pagar en google para Bancolombia Banco y organizar la lista de mayor a menor relevancia incluyendo número de línea al princpio de cada línea siguiente el siguiente ejemplo 1:, luego al frente de cada nombre de categoría agregue : y luego la explicación del contenido de la categoría";
const text = "Cuales son las principales 5 categorías en las cuales google tiene catalogado el dominio www.bancolombia.com ?";
